export const pages = {
  overview: ["数据总览", "产品的每一步成长，都有迹可循。", "◈"],
  users: ["用户管理", "注册用户与当前有效会话，可撤销用户的全部登录会话。", "◎"],
  downloads: ["下载记录", "安装包下载上报事件，按事件 ID 去重；不代表独立用户或安装数。", "↓"],
  crashes: ["崩溃信息", "查看客户端报告，跟进并标记处理状态。", "⚑"],
  skins: ["社区皮肤", "管理用户发布的皮肤；下载数按用户与皮肤去重。", "◧"],
  dictionaries: ["社区词库", "管理公开共享词库，不展示用户的私人词典。", "▤"],
  replies: ["回复模板", "管理社区公开的快捷回复模板。", "≋"],
  audit: ["操作日志", "管理员操作记录，按操作时间倒序排列。", "◷"],
} as const;
