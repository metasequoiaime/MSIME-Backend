...
func TestDocumentationAndBrowserAuthentication(t *testing.T) {
	...
	if json.Unmarshal(w.Body.Bytes(), &spec) != nil || spec.OpenAPI != "3.0.3" || len(spec.Paths) != 64 || spec.Paths["/v1/models"] == nil || spec.Paths["/v1/community/resources/{id}/save"] == nil || spec.Paths["/v1/community/resources/{id}/apply"] == nil {
