...
RUN apt-get update && apt-get install -y --no-install-recommends build-essential cmake libboost-dev libfmt-dev libspdlog-dev libsqlite3-dev nlohmann-json3-dev && rm -rf /var/lib/apt/lists/*
WORKDIR /src
COPY native ./native
